...
Value Compass Benchmarks is a comprehensive, self-evolving, and pluralistic evaluation platform for LLM values, grounded in established value frameworks and continuously updated assessments. As both the landscape of large language models and our evaluation work continue to evolve, manually producing each benchmark report became increasingly time-consuming. This automation pipeline was built to keep pace — detecting what has changed across evaluation rounds, updating findings accordingly, and delivering publication-ready reports without requiring researchers to start from scratch each cycle.
