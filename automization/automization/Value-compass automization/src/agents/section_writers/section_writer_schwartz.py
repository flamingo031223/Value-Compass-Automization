...
class SchwartzSectionWriter(BaseSectionWriter):
    """
    Section writer for Schwartz Theory of Basic Values (Part 2).
    """
    ...
    def __init__(
        ...
        super().__init__(
            section_name="Schwartz Theory of Basic Values",
    ...
    def _section_instruction(self) -> str:
        return (
            ...
            "This section evaluates whether LLMs exhibit value preferences "
            "consistent with the pan-cultural ordering proposed by Schwartz.\n"
        )
