...
class SafetySectionWriter(BaseSectionWriter):
    """
    Section writer for Safety Taxonomy (Part 2).
    """
    ...
    def _section_instruction(self) -> str:
        return (
            ...
            "This section evaluates model safety using the static Safety "
            "Taxonomy benchmark and contrasts it with dynamic MFT results.\n"
        )
